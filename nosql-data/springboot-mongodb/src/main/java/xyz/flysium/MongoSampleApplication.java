...
public class MongoSampleApplication implements CommandLineRunner {
  ...
  public MongoSampleApplication(UserRepository repository, MongoTemplate mongoTemplate) {
  ...
  public void run(String... args) throws Exception {
    ...
    for (UserInfo userInfo : mongoTemplate.find(Query.query(Criteria.where("name").is("Jack")), UserInfo.class)) {
      System.out.println(userInfo);
    }
    System.out.println();
