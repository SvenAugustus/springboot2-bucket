...
import xyz.flysium.SampleAsyncApplication;
 ...
 * @version 1.0
 */
@SpringBootTest(classes = { SampleAsyncApplication.class }/*, webEnvironment = WebEnvironment.RANDOM_PORT*/)
